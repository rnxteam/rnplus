...
function init() {
    if (React) {
        View = createComponent(React, TRUE);
        Component = createComponent(React, FALSE);
    } else {
...
global.PView = View;
global.__PView = View;
global.PComponent = Component;
global.__PComponent = Component;
